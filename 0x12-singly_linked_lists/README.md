...
<p>At the end of this project, you are expected to be able to <a href="/rltoken/XpKKexlcPAQCuAFmEDiu9Q" title="explain to anyone" target="_blank">explain to anyone</a>, <strong>without the help of Google</strong>:</p>
